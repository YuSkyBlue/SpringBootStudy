...
class ArticleServiceTest {
    ...
    @Test
    @Transactional
    void create__성공___title과_content만_있는_dto() {
        //예상
        String title ="라라라라";
        String content ="4444";
    ...
    @Test
    @Transactional
    void update_성공____존재하는_id와_title_content가_있는_dto_입략(){
        //예상
        Long id = 1L;
        String title = "존재하는_ID";
        String content = "존재하는_내용";
    ...
    @Test
    @Transactional
    void update_실패____존재하지않는_id의_dto_입략(){
        //예상
        Long id = 5L;
        String title = "존재하는_ID";
        String content = "존재하는_내용";
    ...
    @Test
    @Transactional
    void update_실패____id의만_있는_dto_입략() {
        //예상
        Long id = 1L;
        String title = null;
        String content = null;
    ...
    @Test
    @Transactional
    void delet_실패____존재하지_않는_id_입력() {
